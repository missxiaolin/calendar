...
var SimpleDayGridEventRenderer = /** @class */ (function(_super) {
  ...
  SimpleDayGridEventRenderer.prototype.renderSegHtml = function(
    ...
    console.log(
      `${eventDef.extendedProps.principal}--${eventDef.extendedProps.isShow}`
    );
    ...
    var isResizableFromEnd =
      allDay && seg.isEnd && view.computeEventEndResizable(eventDef, eventUi);
    ...
    // 改造点，当前项目是否显示
    if (!eventRange.def.extendedProps.isShow) {
      return "<a style='display:none'></a>";
    }
    titleHtml = `<span class="fc-title">${
      eventDef.extendedProps.principal
        ? eventDef.extendedProps.principal + " - "
        : ""
    }${eventDef.title}${
      eventDef.extendedProps.type ? " - " + eventDef.extendedProps.type : ""
    }</span>`;
    return (
      '<a class="' +
      classes.join(" ") +
      ...
      ">" +
      '<div class="fc-content  test-1-test">' +
      (options.dir === "rtl"
...
var DayGridView = /** @class */ (function(_super) {
  ...
  function DayGridView(context, viewSpec, dateProfileGenerator, parentEl) {
    ...
    _this.el
      ...
      .appendChild(dayGridContainerEl);
  ...
  DayGridView.prototype.updateBaseSize = function(
    isResize,
    viewHeight,
    isAuto
  ) {
...
export default main;
export {
  DayGridView as AbstractDayGridView,
  DayBgRow,
  DayGrid,
  DayGridSlicer,
  DayGridView$1 as DayGridView,
  SimpleDayGrid,
