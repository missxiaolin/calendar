...
import {
  ...
  DayGrid,
  SimpleDayGrid
} from "@/components/@fullcalendar/daygrid";
...
var TimeGridEventRenderer = /** @class */ (function(_super) {
  ...
  TimeGridEventRenderer.prototype.renderSegHtml = function(seg, mirrorInfo) {
    ...
    return (
      ...
      ">" +
      '<div class="fc-content test--test">' +
      (timeText
        ? '<div class="fc-time"' +
          ' data-start="' +
        ...
        : "") +
      (eventDef.title
        ? '<div class="fc-title">' + htmlEscape(eventDef.title) + "</div>"
        : "") +
      "</div>" +
...
var TimeGrid = /** @class */ (function(_super) {
  ...
  function TimeGrid(context, el, renderProps) {
    ...
    var eventRenderer = (_this.eventRenderer = new TimeGridEventRenderer(
      _this
    ));
    var fillRenderer = (_this.fillRenderer = new TimeGridFillRenderer(_this));
    _this.mirrorRenderer = new TimeGridMirrorRenderer(_this);
    var renderColumns = (_this.renderColumns = memoizeRendering(
  ...
  TimeGrid.prototype.renderSlatRowHtml = function(dateProfile) {
    ...
    while (asRoughMs(slotTime) < asRoughMs(dateProfile.maxTime)) {
      ...
      isLabeled =
        wholeDivideDurations(slotIterator, this.labelInterval) !== null;
      axisHtml =
  ...
  TimeGrid.prototype.computeTimeTop = function(duration) {
    ...
    var slatCoverage =
      (duration.milliseconds - asRoughMs(dateProfile.minTime)) /
      asRoughMs(this.slotDuration); // floating-point value of # of slots covered
    var slatIndex;
    var slatRemainder;
...
var TimeGridView = /** @class */ (function(_super) {
  ...
  function TimeGridView(context, viewSpec, dateProfileGenerator, parentEl) {
    ...
    _this.scroller = new ScrollComponent(
      "hidden", // overflow x
      "auto" // overflow y
    );
  ...
  TimeGridView.prototype.updateBaseSize = function(
    ...
    var noScrollRowEls = findElements(this.el, ".fc-row").filter(function(
      node
    ) {
...
var TimeGridView$1 = /** @class */ (function(_super) {
  ...
  function TimeGridView(_context, viewSpec, dateProfileGenerator, parentEl) {
    var _this =
      _super.call(this, _context, viewSpec, dateProfileGenerator, parentEl) ||
      this;
    _this.buildDayTable = memoize(buildDayTable);
    if (_this.opt("columnHeader")) {
      _this.header = new DayHeader(
        _this.context,
