...
(function(global, factory) {
  typeof exports === "object" && typeof module !== "undefined"
    ...
    : ((global = global || self),
      factory((global.FullCalendarVue = {}), global.FullCalendar));
  ...
  */
  ...
  var EMISSION_NAMES = [
    ...
    "eventReceive",
    "eventLeave",
    "_destroyed", // should now be props... (TODO: eventually remove)
    "datesRender",
    "datesDestroy",
    "dayRender",
    "eventRender",
  ...
  */
  ...
  var FullCalendarComponent = {
    ...
    mounted: function mounted() {
      ...
      this.$options.calendar = new core.Calendar(
        this.$el,
    ...
    methods: {
      buildCalendarOptions: function buildCalendarOptions() {
        ...
        try {
          ...
          for (
            var _iterator = EMISSION_NAMES[Symbol.iterator](), _step;
      ...
      recordDirtyOption: function recordDirtyOption(optionName, newVal) {
        (this.$options.dirtyOptions || (this.$options.dirtyOptions = {}))[
          optionName
        ] = newVal;
      ...
      renderDirty: function renderDirty() {
        ...
        if (dirtyOptions) {
          ...
          this.$options.calendar.mutateOptions(
            dirtyOptions,
            [],
            false,
            fastDeepEqual
    ...
    for (var emissionName in listenerHash) {
      if (EMISSION_USE_PROP[emissionName]) {
        console.warn(
          "Use of " +
            emissionName +
            " as an event is deprecated. Please convert to a prop."
        );
      }
    }
  }
